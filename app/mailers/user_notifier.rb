class UserNotifier < ApplicationMailer
  ...
  def welcome(user, user_email)
    @user = user
    mail(to: user_email, subject: "Welcome to Bitsbee Lending, #{@user.first_name}!")
  end

  def unwelcome(user, user_email)
    @user = user
    mail(to: user_email, subject: "Farewell from Bitsbee Lending, #{@user.first_name}!")
  end
  ...
  def forgot_password(user)
    @user = user
    mail(to: user.email, subject: "Reset your Bitsbee Lending password, #{@user.first_name}")
  end
